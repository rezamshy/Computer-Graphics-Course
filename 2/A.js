...
function drawCissoid(k , c){
  ...
  i = 0;
  while (d2[i] < 0) {
    let p = new Point(x[i], y[i] , 5, c);
    p.draw();
    p = new Point(x[i], -y[i] , 5, c);
    p.draw();
    x[i+1] = x[i] + 1;
    if (d1[i] < 0){
      y[i+1] = y[i];
      d1[i+1] = d1[i] + 12 * Math.pow(x[i], 2) + 36 * x[i] + 4 * Math.pow(y[i], 2) + 4 * y[i] + 29;
      d2[i+1] = d2[i] + 24 * Math.pow(x[i], 2) + 48 * x[i] + 8 * Math.pow(y[i], 2) + 16 * y[i] + 34;
    }
    else{
      y[i+1] = y[i] + 1;
      d1[i+1] = d1[i] + 12 * Math.pow(x[i], 2) + 44 * x[i] + 8 * x[i] * y[i] + 14 * Math.pow(y[i], 2) + (20 - 32 * k) * y[i] + 45 - 32 * k;
      d2[i+1] = d2[i] + 24 * Math.pow(x[i], 2) + 72 * x[i] + 8 * Math.pow(y[i], 2) + (40 - 64 * k) * y[i] + 16 * x[i] * y[i] + 70 - 96 * k;
    }
    i++;
  }
  ...
  while (x[i] < 4*k) {
    ...
    if (d2[i] < 0){
      ...
      x[i+1] = x[i];
      d2[i+1] = d2[i] + 24 * x[i] + (8 - 64 * k) * y[i] + 16 * x[i] * y[i] + 12 - 96 * k;
    }
    i++;
  }
