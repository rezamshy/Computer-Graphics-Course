...
function render() {
    ...
    world.list.push(new Sphere(new Vector(0, -500, -1), 500, new LambertianMaterial(new Solid_Color(0, 0.7, 0.9))));
    world.list.push(new Sphere(new Vector(0, 1, 1), 1, new LambertianMaterial(new Solid_Color(0.7, 1, 0))));
