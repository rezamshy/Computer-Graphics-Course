...
var gl, a_Position, a_Color, a_Normal, u_ModelMatrix, u_VpMatrix, u_NormalMatrix, lightPosition;
var g_modelMatrix, g_normalMatrix, g_vpMatrix;

function main() {
  // Retrieve <canvas> element
  var canvas = document.getElementById('webgl', {stencil : true});
...
Plane.prototype = {
  ...
  shadow: function(sy , cube){
    ...
    modelMatrix.multiply(g_modelMatrix);
