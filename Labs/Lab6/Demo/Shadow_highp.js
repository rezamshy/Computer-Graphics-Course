...
function drawSphere(gl, program, sphere, viewProjMatrix) {
  ...
  g_modelMatrix.setScale(3, 3, 3);
  g_modelMatrix.translate(0, -0.7, 0);
...
function initVertexBuffersForSphere(gl) {
  ...
  var sphere = {
    "vertexBuffer": initArrayBufferForLaterUse(gl, new Float32Array(positions), 3, gl.FLOAT),
    "colorBuffer" : initArrayBufferForLaterUse(gl, new Float32Array(positions), 3, gl.FLOAT),
    "indexBuffer" : initElementArrayBufferForLaterUse(gl, new Uint8Array(indices), 3, gl.UNSIGNED_BYTE),
