...
float sceneSDF(vec3 samplePoint) {
    vec3 center1 = vec3(0.35, 0.0, 0.0);
    vec3 a1 = vec3(0.1, 0.1, 0.1);
    vec3 d1 = vec3(0.1, 0.1, 0.1);

    vec3 center2 = vec3(-0.35, 0.0, 0.0);
    vec3 a2 = vec3(0.1, 0.1, 0.9);
    vec3 d2 = vec3(0.1, 0.1, 0.9);

    return min(xytorusSDF(samplePoint, center1, 0.3, 0.05, a1, d1), xytorusSDF(samplePoint, center2, 0.3, 0.05, a2, d2));
}
