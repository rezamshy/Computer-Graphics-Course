...
float sceneSDF(vec3 samplePoint) {
    ...
    vec3 center4 = vec3(-0.35, -0.25, 0.0);
    vec3 a4 = vec3(0.8, 0.8, 0.1);
    vec3 d4 = vec3(0.8, 0.8, 0.1);

    vec3 center5 = vec3(0.35, -0.25, 0.0);
    ...
    return min(
      min(
        ...
        xytorusSDF(samplePoint, center4, 0.3, 0.05, a4, d4)
      ),
      xytorusSDF(samplePoint, center5, 0.3, 0.05, a5, d5)
    );
}
